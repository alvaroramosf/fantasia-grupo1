...
public class Légolas {

	public static void main(String[] args) {
		System.out.println("Legolas es un elfo sindariano de los bosques de Mirkwood, "
				+ "hijo del rey Thranduil, y uno de los miembros de la Comunidad del Anillo."
